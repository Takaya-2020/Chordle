function keyboardwidget(){
  ...
  var LiveKeyboard = function (container, o) {
    ...
    this._mode = o.mode || 'polyphonic'; // 'monophonic', 'polyphonic'
  ...
  LiveKeyboard.prototype = {
    ...
    numWhiteKeys: function () {
      ...
      var bottomNote = this._bottomNote;https://developer.mozilla.org/ja/docs/Web/JavaScript/Guide/Working_with_Objects
